...
namespace DolphinScript.Event.Pause
{
    ...
    public class PauseWhileColourExistsInAreaOnWindow : ScriptEvent
    {
        ...
        public override void Invoke()
        {
            ...
            //
            _scriptState.Status = $"Pause while colour: {SearchColour} is found in area: {newSearchArea.PrintArea()} on window: {WindowToClickTitle}, waiting {_scriptState.SearchPause} seconds before re-searching.";
